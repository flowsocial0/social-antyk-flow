  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4">
      <Helmet>
        ...
        <meta name="description" content="Polityka prywatności SocialFlow - dowiedz się jak chronimy Twoje dane osobowe" />
      </Helmet>
          ...
          <CardContent className="prose prose-slate dark:prose-invert max-w-none space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                przekazanych przez Użytkowników w związku z korzystaniem z usług aplikacji SocialFlow.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Administratorem danych osobowych zbieranych za pośrednictwem aplikacji SocialFlow jest 
                Księgarnia Antyk.
              </p>
              <p className="text-muted-foreground">
                Kontakt z Administratorem możliwy jest poprzez adres e-mail: kontakt@antyk.pl
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  <strong>Świadczenia usług</strong> - umożliwienie korzystania z funkcjonalności aplikacji 
                  (podstawa: wykonanie umowy - art. 6 ust. 1 lit. b RODO)
                </li>
                <li>
                  <strong>Autoryzacji i autentykacji</strong> - zarządzanie kontami użytkowników 
                  (podstawa: wykonanie umowy - art. 6 ust. 1 lit. b RODO)
                </li>
                <li>
                ...
                <li>
                  <strong>Bezpieczeństwa systemu</strong> - ochrona przed nadużyciami i zapewnienie 
                  bezpieczeństwa danych (podstawa: prawnie uzasadniony interes - art. 6 ust. 1 lit. f RODO)
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  <strong>Platformom społecznościowym</strong> - Facebook, X/Twitter, Instagram - 
                  w zakresie niezbędnym do publikacji treści
                </li>
                <li>
                  <strong>Dostawcom usług IT</strong> - Supabase (hosting bazy danych), 
                  dostawcom usług chmurowych
                </li>
                <li>
                  <strong>Podmiotom uprawnionym</strong> - na podstawie przepisów prawa 
                  (np. organom państwowym)
                </li>
              </ul>
              <p className="text-muted-foreground mt-4">
                Wszystkie podmioty trzecie przetwarzające dane działają na podstawie umów powierzenia 
                przetwarzania danych i zapewniają odpowiedni poziom ochrony.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                (np. w związku z usługami świadczonymi przez X/Twitter). W takich przypadkach stosujemy 
                odpowiednie zabezpieczenia, takie jak standardowe klauzule umowne zatwierdzone przez 
                Komisję Europejską.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>Do momentu zgłoszenia sprzeciwu (w przypadku przetwarzania na podstawie 
                prawnie uzasadnionego interesu)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li><strong>Sprostowania danych</strong> - poprawiania nieprawidłowych danych</li>
                <li><strong>Usunięcia danych</strong> - "prawa do bycia zapomnianym"</li>
                <li><strong>Ograniczenia przetwarzania</strong> - w określonych sytuacjach</li>
                <li><strong>Przenoszenia danych</strong> - otrzymania danych w formacie umożliwiającym 
                ich przeniesienie</li>
                <li><strong>Sprzeciwu</strong> - wobec przetwarzania danych na podstawie prawnie 
                uzasadnionego interesu</li>
                <li><strong>Wycofania zgody</strong> - w dowolnym momencie, bez wpływu na zgodność z prawem 
                przetwarzania dokonanego przed wycofaniem zgody</li>
                <li><strong>Wniesienia skargi</strong> - do organu nadzorczego (Prezes Urzędu Ochrony 
                Danych Osobowych)</li>
              </ul>
              <p className="text-muted-foreground mt-4">
                W celu realizacji powyższych praw prosimy o kontakt na adres: kontakt@antyk.pl
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Aplikacja wykorzystuje pliki cookies (ciasteczka) w celu:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground">11. Automatyczne podejmowanie decyzji i profilowanie</h2>
              <p className="text-muted-foreground">
                Aplikacja nie wykorzystuje zautomatyzowanego podejmowania decyzji ani profilowania 
                w rozumieniu art. 22 RODO, które wywołują skutki prawne lub w podobny sposób istotnie 
                wpływają na użytkownika.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                O wszelkich zmianach użytkownicy zostaną poinformowani poprzez komunikat w aplikacji lub 
                wiadomość e-mail. Zmiany wchodzą w życie w terminie wskazanym w powiadomieniu, nie 
                wcześniej jednak niż po upływie 14 dni od jego opublikowania.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                swobodnego przepływu takich danych (RODO) oraz przepisy prawa polskiego.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                W przypadku pytań dotyczących ochrony danych osobowych lub chęci skorzystania z 
                przysługujących praw, prosimy o kontakt:
              </p>
              <div className="bg-muted p-4 rounded-lg mt-4">
                <p className="text-foreground"><strong>Księgarnia Antyk</strong></p>
                <p className="text-muted-foreground">Email: kontakt@antyk.pl</p>
              </div>
            </section>
          </CardContent>
        </Card>
