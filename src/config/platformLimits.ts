...
export const platformLimits: Record<PlatformId, PlatformLimits> = {
  ...
  discord: {
    ...
    maxVideos: 1,
    authType: 'api-key',
    apiDocumentation: 'https://discord.com/developers/docs/resources/webhook',
  },
  tumblr: {
    id: 'tumblr',
    textLimit: 4096,
    ...
    maxVideos: 1,
    authType: 'oauth2',
    apiDocumentation: 'https://www.tumblr.com/docs/en/api/v2',
  },
  snapchat: {
    id: 'snapchat',
    textLimit: 80,
    ...
    maxVideos: 1,
    authType: 'oauth2',
    apiDocumentation: 'https://developers.snap.com/api/marketing-api/overview',
  },
  google_business: {
    id: 'google_business',
    textLimit: 1500,
    ...
    maxImages: 10,
    authType: 'oauth2',
    apiDocumentation: 'https://developers.google.com/my-business/reference/rest',
  },
};
